...
export function* onLogInStart() {
  yield takeLatest(authConstant.LOGIN_REQUEST, logInWithCredentials);
}

export function* isUserLoggedIn() {
  yield takeEvery(authConstant.KEEP_LOGIN, isUserAlreadyLoggedIn);
}

export function* onLogOut() {
  yield takeEvery(authConstant.LOG_OUT, logoutRequest);
}
